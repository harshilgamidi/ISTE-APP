...
const PaymentPage = ({navigation}) => {
  ...
  return (
    ...
    <View style ={styles.s2}>
      <Text style = {styles.Mainhead}>Payment</Text>
      <Text style = {header1}>Membership Registration.</Text>
      {
  ...
  <View style={styles.inputView}>
      ...
      <View style={styles.inputView}>
        <TextInput
          ...
          placeholderTextColor="white"
          onChangeText={(text)=>Setinputs({...inputs,RegNo:text})}
        />
      </View>
      <View style={styles.inputView}>
        <TextInput
      ...
      <Text style = {{fontSize:20, color:"grey",textAlign:"center",marginTop:10}}>Amount to be Paid : 300/-</Text>
      <TouchableOpacity style={styles.loginBtn}
       onPress ={handleSubmit}>
        <Text style={styles.loginText}>Paynow</Text>
      </TouchableOpacity>
    </View>
      </View>
      </View>
